...
export default function StatsBanner() {
  const stats = [
    ...
    },
    {
      ...
      label: "Flashlights",
      icon: (
        <svg className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8 text-primary" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Outer rectangular frame */}
          <rect x="2" y="4" width="28" height="24" rx="3" fill="none" stroke="currentColor" strokeWidth="2.5" />
          {/* Inner dotted border */}
          <rect x="4" y="6" width="24" height="20" rx="1.5" fill="none" stroke="currentColor" strokeWidth="1" strokeDasharray="2 1" />
          {/* ISI Text */}
          <text x="16" y="20" textAnchor="middle" fill="currentColor" fontFamily="Arial Black, Impact, sans-serif" fontSize="11" fontWeight="900" letterSpacing="0.8">ISI</text>
        </svg>
      ),
    },
  ];
