          ...
          {stats.map((stat, idx) => (
            <div
              ...
              className={`flex items-center gap-6 ${
                idx > 0 ? "pt-6 md:pt-0 lg:pl-8" : ""
              } ${idx === 2 ? "md:pl-0" : ""}`}
            >
              <div className="flex-shrink-0 p-3 bg-blue-50/50 rounded-2xl">
                {stat.icon}
              </div>
              <div className="flex flex-col">
                <span className="text-3xl font-extrabold text-dark-navy leading-none tracking-tight">
                  {stat.value}
                </span>
                <span className="text-sm font-semibold text-slate-light mt-1.5 leading-tight">
                  {stat.label}
                </span>
              </div>
            </div>
